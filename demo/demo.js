...
// 	artists.eq(0).metadata('name', 'Jesu');

// 	artists.eq(1).metadata({
// 		name: 'Jesu Two',
...
$(function() {
	...
	var code = $('<code/>', {
		text: JSON.stringify(albums.metadata(false), null, 2)
	});
...
$(function() {
	...
	var code = $('<code/>', {
		text: JSON.stringify(albums.metadata(true), null, 2)
	});

	$('#metadata-expanded').append(code);
});